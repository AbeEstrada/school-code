...
(function(window, document, undefined) {
    ...
    var defaults = {
        messages: {
            ...
            valid_email: 'El campo %s tiene que contener una dirección de email válida.',
            min_length: 'El campo %s debe contener al menos %s caracteres de longitud.',
            max_length: 'El campo %s no debe de pasar de %s caracteres de longitud.',
            exact_length: 'El campo %s debe contener %s caracteres de lóngitud.',
            greater_than: 'El campo %s debe contener un número mayor a %s.',
            less_than: 'El campo %s debe contener un número menor a %s.',
